...
| Issuer, SPY, and sector one-minute bars | Existing Alpaca historical SIP bars capability | Exact provider/dataset/feed/channel and symbols configured | Credential, entitlement, zero-spend, and live authorization |
